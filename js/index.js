...
function pointRecu() {
	...
	if (ajaxRequest.readyState==4) {
		if (ajaxRequest.status==200) {
			...
			document.getElementById('idPoint').innerHTML = "(Point n°<a href='http://www.refuges.info/point/" + point.properties.id + "' title='Informations détaillées sur le point, version ordinateur'>" + point.properties.id + "</a>)<br />Édité le " + point.properties.derniere_modif;
			...
			if (point.properties.com_0 != undefined) { document.getElementById('com0Point').innerHTML = '<p class="legendecom">' + point.properties.date_com_0 + ' par ' + point.properties.auteur_com_0 + '</p><br /><p class="com">' + point.properties.com_0 + '<br /><a href="http://leo.refuges.info' + point.properties.photo_com_0 + '" target="_blank"><img src="http://leo.refuges.info' + point.properties.miniature_com_0 + '" /></a></p>'; } else { removeElement("com0Point"); }
			if (point.properties.com_1 != undefined) { document.getElementById('com1Point').innerHTML = '<p class="legendecom">' + point.properties.date_com_1 + ' par ' + point.properties.auteur_com_1 + '</p><br /><p class="com">' + point.properties.com_1 + '<br /><a href="http://leo.refuges.info' + point.properties.photo_com_1 + '" target="_blank"><img src="http://leo.refuges.info' + point.properties.miniature_com_1 + '" /></a></p>'; } else { removeElement("com1Point"); }
			if (point.properties.com_2 != undefined) { document.getElementById('com2Point').innerHTML = '<p class="legendecom">' + point.properties.date_com_2 + ' par ' + point.properties.auteur_com_2 + '</p><br /><p class="com">' + point.properties.com_2 + '<br /><a href="http://leo.refuges.info' + point.properties.photo_com_2 + '" target="_blank"><img src="http://leo.refuges.info' + point.properties.miniature_com_2 + '" /></a></p>'; } else { removeElement("com2Point"); }
			if (point.properties.com_3 != undefined) { document.getElementById('com3Point').innerHTML = '<p class="legendecom">' + point.properties.date_com_3 + ' par ' + point.properties.auteur_com_3 + '</p><br /><p class="com">' + point.properties.com_3 + '<br /><a href="http://leo.refuges.info' + point.properties.photo_com_3 + '" target="_blank"><img src="http://leo.refuges.info' + point.properties.miniature_com_3 + '" /></a></p>'; } else { removeElement("com3Point"); }
			if (point.properties.com_4 != undefined) { document.getElementById('com4Point').innerHTML = '<p class="legendecom">' + point.properties.date_com_4 + ' par ' + point.properties.auteur_com_4 + '</p><br /><p class="com">' + point.properties.com_4 + '<br /><a href="http://leo.refuges.info' + point.properties.photo_com_4 + '" target="_blank"><img src="http://leo.refuges.info' + point.properties.miniature_com_4 + '" /></a></p>'; } else { removeElement("com4Point"); }
